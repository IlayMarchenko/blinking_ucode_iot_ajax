...
GPIO_PinConfig gpioPinConfigs[] = {
    /* CONFIG_GPIO_LED_0_GPIO : LaunchPad LED Red */
    GPIOCC26XX_DIO_06 | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW,
    /* CONFIG_GPIO_LED_1_GPIO : LaunchPad LED Green */
...
const uint_least8_t CONFIG_GPIO_LED_0_GPIO_CONST = CONFIG_GPIO_LED_0_GPIO;
const uint_least8_t CONFIG_GPIO_LED_1_GPIO_CONST = CONFIG_GPIO_LED_1_GPIO;
...
const PIN_Config BoardGpioInitTable[CONFIG_PIN_COUNT + 1] = {
    /* LaunchPad LED Red, Parent Signal: CONFIG_GPIO_LED_0_GPIO GPIO Pin, (DIO6) */
    CONFIG_PIN_0 | PIN_GPIO_OUTPUT_EN | PIN_GPIO_LOW | PIN_PUSHPULL | PIN_DRVSTR_MED,
    /* LaunchPad LED Green, Parent Signal: CONFIG_GPIO_LED_1_GPIO GPIO Pin, (DIO7) */
...
static const LED_HWAttrs LEDHWAttrs[CONFIG_LED_COUNT] = {
    ...
    /* LaunchPad LED Red */
    {
        ...
        .index = CONFIG_GPIO_LED_0_GPIO,
    },
    /* CONFIG_GPIO_LED_1 */
    /* LaunchPad LED Green */
    {
        .type = LED_GPIO_CONTROLLED,
        .index = CONFIG_GPIO_LED_1_GPIO,
    },
};
...
const LED_Config LED_config[CONFIG_LED_COUNT] = {
    ...
    /* LaunchPad LED Red */
    {
        .object = &LEDObjects[CONFIG_GPIO_LED_0],
        .hwAttrs = &LEDHWAttrs[CONFIG_GPIO_LED_0]
    },
    /* CONFIG_GPIO_LED_1 */
    /* LaunchPad LED Green */
    {
        .object = &LEDObjects[CONFIG_GPIO_LED_1],
        .hwAttrs = &LEDHWAttrs[CONFIG_GPIO_LED_1]
    },
};
